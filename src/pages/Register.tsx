...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-20 right-10 w-72 h-72 rounded-full opacity-20 dark:opacity-10" style={{ background: "hsl(262, 83%, 70%)", filter: "blur(80px)" }} />
      <div className="absolute bottom-20 left-10 w-60 h-60 rounded-full opacity-20 dark:opacity-10" style={{ background: "hsl(38, 92%, 70%)", filter: "blur(80px)" }} />
        ...
        <div className="glass-card-strong rounded-3xl p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="confirm" type="password" placeholder="••••••••" value={confirm} onChange={e => setConfirm(e.target.value)} className="rounded-xl" />
            </div>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 font-display font-semibold gap-3 rounded-xl"
